...
-- Records of pdetalle
-- ----------------------------
INSERT INTO `pdetalle` VALUES ('5246', '10301021	', 'Acetaminofen 100 mg/ml Solución Oral Gotas 30ml/Frasco 1/Caja (Ramos)', '5', '10');
INSERT INTO `pdetalle` VALUES ('5245', '10301021', 'Acetaminofen 100 mg/ml Solución Oral Gotas 30ml/Frasco 1/Caja (Ramos)', '100', '2');
INSERT INTO `pdetalle` VALUES ('5245', '12901011', 'Acetaminofen 120 mg/5ml Jarabe 120 ml/Frasco 1/Caja (Lancasco)', '150', '2');
INSERT INTO `pdetalle` VALUES ('5246', '18817041', '	Acetazolamida 250 mg Tabletas 30/Caja (UNIMARK-India)', '500', '1');
INSERT INTO `pdetalle` VALUES ('5246', '10118011', 'Acido Zoledronico 4mg/5ml Sol. Iny I.V 5ml/Vial 1/Caja (Naprod)', '10', '20000');
INSERT INTO `pdetalle` VALUES ('5246', '18918011', 'Acido Transretinoico 10 mg Cápsulas 100/Caja (Cheplapharm)', '15', '1000');
...
-- Records of pedido
-- ----------------------------
INSERT INTO `pedido` VALUES ('5245', '1', '2016-08-13', null, 'Farmacia la Carera', 'Da muy caro todo', null, null, null, null, null, 'Da muy caro todo', '', '0');
INSERT INTO `pedido` VALUES ('5246', '2', '2016-08-13', null, 'FARMACIA LA LADRONA', 'mucho roba', null, null, null, null, null, 'mucho roba', '', '1');
...
-- ----------------------------
-- View structure for viewestados
-- ----------------------------
DROP VIEW IF EXISTS `viewestados`;
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER  VIEW `viewestados` AS select `pedido`.`IdPedido` AS `IdPedido`,left(`pedido`.`IdPedido`,3) AS `IdVenedor`,`pedido`.`Estado` AS `Estado` from `pedido` where (`pedido`.`Estado` <> '0') ;
...
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost`  VIEW `view_pedidos` AS SELECT
pedido.Cliente,
pdetalle.IdPedido,
pdetalle.IdArticulo,
...
pedido.IdPedido,
LEFT(pedido.IdPedido,3)AS IdVendedor,
pedido.IdCliente,
pedido.Cliente,
pedido.Monto
FROM
